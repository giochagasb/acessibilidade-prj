    ...
    <?php include_once('php/header.php'); ?>
            ...
            <div class="col card" style="flex-direction: row;">
                ...
                <div>
                    <div class="card-body px-4 py-2 p-0">
                        <p class="card-text py-3">Daniel</p>
        ...
        <div class="row row-cols-1 row-cols-md-7 g-4">
            <div class="col card" style="flex-direction: row;">
                ...
                <div>
                    <div class="card-body px-4 py-2 p-0">
                        <p class="card-text py-3">Jaquelini</p>
        ...
        <div class="row row-cols-1 row-cols-md-7 g-4">
            <div class="col card" style="flex-direction: row;">
                ...
                <div>
                    <div class="card-body px-4 py-2 p-0">
                        <p class="card-text py-3">José Guilherme</p>
        ...
        <div class="row row-cols-1 row-cols-md-7 g-4">
            <div class="col card" style="flex-direction: row;">
                ...
                <div>
                    <div class="card-body px-4 py-2 p-0">
                        <p class="card-text py-3">Sthefani</p>
